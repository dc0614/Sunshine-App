...
//  Completed (1) Implement the delete method of the ContentProvider
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        // Keep track of the number of rows delete
...
//          Completed (2) Only implement the functionality, given the proper URI, to delete ALL rows in the weather table
        switch (match){
            case CODE_WEATHER:
                //use String value 1 in where clause to delete all rows and return a count
                rowsDeleted = db.delete(TABLE_NAME, selection, null);
                break;
